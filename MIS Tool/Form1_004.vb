...
Public Class Form1
    ...
    Private Sub option606() 'CGL data upload
    ...
    Private Sub option601()   'eNMGB Migration - Data Check Reports
        ...
        If username.Length > 4 Then
            If username.Substring(0, 4).ToUpper = "MIG0" Then
                ...
                Else
                    ...
                    Dim sql1 As String
                    sql1 = "SELECT DISTINCT BRANCH_NO FROM MIG_SUMMARY WHERE BRANCH_NO = '" & branchcode & "' ORDER BY BRANCH_NO"
                    Dim cmd1 As New OracleCommand(sql1, oracle_conn)
                    Dim dr15 As OracleDataReader = cmd1.ExecuteReader()
                    Dim branchcode1 As String
                    While dr15.Read
                        branchcode1 = dr15.Item("BRANCH_NO").ToString.Trim
                    End While
                    dr15.Close()
                    ...
                    Else
                        ...
                        Dim cmd5 As New OracleCommand(sql, oracle_conn)
                        cmd5.CommandType = CommandType.StoredProcedure
                        cmd5.Parameters.Add("BR_CODE", OracleDbType.Varchar2, 50, Nothing, ParameterDirection.Input).Value = Trim(branchcode)
                        cmd5.Parameters.Add("REPORTID", OracleDbType.Varchar2, 50, Nothing, ParameterDirection.Input).Value = Trim(reportid1)
                        cmd5.ExecuteNonQuery()

                        Dim sw As StreamWriter = New StreamWriter("C:\du\" & branchcode & "_" & reportid1 & "_" & reportfilename & ".txt")
                        Dim sql2 As String
                        sql2 = "SELECT REPORTDATA FROM C_MISPRINT ORDER BY SERIALNO,SUBSERIALNO"
                        Dim cmd2 As New OracleCommand(sql2, oracle_conn)
                        Dim dr2 As OracleDataReader = cmd2.ExecuteReader()
    ...
    Private Sub option602()   'eNMGB Migration - Data Comparison Reports
    ...
    Private Sub option603()   'eNMGB Migration - FUF Files
                ...
                If branchcode = "ALL" Then
                    ...
                    While dr1.Read
                        ...
                        If reportid = "ALL" Then
                            ...
                            Dim sql3 As String
                            sql3 = "SELECT REPORT_ID,REPORT_FILE_NAME FROM RI WHERE REPORT_TYPE = 'FUF' ORDER BY REPORT_TYPE"
                            Dim cmd3 As New OracleCommand(sql3, oracle_conn)
                            Dim dr3 As OracleDataReader = cmd3.ExecuteReader()
                        ...
                        Else
                            ...
                            Dim sql4 As String
                            sql4 = "SELECT REPORT_ID,REPORT_FILE_NAME FROM RI WHERE REPORT_TYPE = 'FUF' AND REPORT_ID =  '" & reportid & "' ORDER BY REPORT_TYPE"
                            Dim cmd4 As New OracleCommand(sql4, oracle_conn)
                            Dim dr14 As OracleDataReader = cmd4.ExecuteReader()
    ...
    Private Sub option39()   'eNMGB - Migration Tool Data Entry Status
    ...
    Private Sub populate_label()
        ...
        ElseIf txtmenu.Text = "Alter" Then
            rptoption = 604
            'lblinfo1.Text = "Database: Ten; User Name: EMail"
            lblinfo2.Text = "Run the programme."
            lblinfo3.Text = ""
        ...
        ElseIf txtmenu.Text = "Update" Then
            rptoption = 605
            'lblinfo1.Text = "Database: Ten; User Name: EMail"
            lblinfo2.Text = "Run the programme."
            lblinfo3.Text = ""
        ...
        ElseIf txtmenu.Text = "eNMGB Migration - FUF Files" Then
            rptoption = 603
            'lblinfo1.Text = "Database: Ten; User Name: EMail"
            lblinfo2.Text = "Input Box1: Enter Branch Code"
            lblinfo3.Text = "Input Box2: Enter Report ID"
        ...
        ElseIf txtmenu.Text = "eNMGB - Migration Tool Data Entry Status" Then
            rptoption = 39
            'lblinfo1.Text = "Database: Ten; User Name: EMail"
