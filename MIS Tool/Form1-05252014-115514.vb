...
Public Class Form1
    ...
    Private Sub Button1_Click_1(ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click
        'Oracle Database Access Start
        'Declare the following in the beginning - Imports Oracle.DataAccess.Client
        'Add reference Oracle.DataAccess.dll through Project >> References (DLL Located in C:\oracle\product\10.2.0\client_1\BIN)

        'Declare the following in the beginning for file related operations

        'Imports System
        'Imports System.IO
        'Imports System.Text

        'Dim sql As String = "PKGEMAIL.GETDATA"
        ...
        Catch ex As Exception
            ...
            'MsgBox(ex.Message, MsgBoxStyle.Critical, "Invalid date")
            Exit Sub
    ...
    Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ...
        'populate_dgv("0")
        'format_dgv("1")
        'cmbOption.Items.Add("Aadhaar Upload - Delete Duplicate Records")
        'cmbOption.Items.Add("Daily EMails")
        'cmbOption.Items.Add("Upload Files")
        'cmbOption.Items.Add("Tabdata")
        'cmbOption.Items.Add("General")
        'cmbOption.Items.Add("Report")
        'cmbOption.Items.Add("KGB Daily Reports")
        'cmbOption.Items.Add("Business Review")
        'cmbOption.Items.Add("KGB First - Outstanding")
        'cmbOption.Items.Add("KGB First - Disbursement")
        'cmbOption.Items.Add("KGB First - NPA")
        'cmbOption.Items.Add("MISDO Upload")
        'cmbOption.Items.Add("ATM Data Mismatch between Finacle & Switch reports")
        'cmbOption.Items.Add("CIBIL Upload File Creation")
        'cmbOption.Items.Add("EMail Daily Reports")
        'cmbOption.Items.Add("NPCI Linked Aadhaar - Upload file creation")
        'cmbOption.Items.Add("Day end EMails")
        'cmbOption.Items.Add("Business Review - Files to RO")
        'cmbOption.Items.Add("9071 Insert")
        'cmbOption.Items.Add("9072 Insert")
        'cmbOption.Items.Add("9074 Insert")
        'cmbOption.Items.Add("Create RO and Branch Folders and convert CIB Files")
        'cmbOption.Items.Add("Create Bank as a whole/All RO's/All Branches report in a single file")
        'cmbOption.Items.Add("Get File Names")
        'cmbOption.Items.Add("Word Document Generation")

        'cmbOption.Items.Add("KGB Aadhar Enrolled Status")
        'cmbOption.Items.Add("KGB Business Progress Report")
        'cmbOption.Items.Add("KGB Day Book")
    ...
    'Private Sub cmbOption_SelectedIndexChanged(sender As Object, e As EventArgs)
    'Private Sub cmbOption_SelectedIndexChanged_1(ByVal sender As Object, ByVal e As EventArgs)

    '    Button3.Enabled = False
    '    If cmbOption.Text = "Aadhaar Upload - Delete Duplicate Records" Then
    '        rptoption = 1
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "Daily EMails" Then
    '        rptoption = 2
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "Upload Files" Then
    '        rptoption = 3
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "Tabdata" Then
    '        rptoption = 4
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "General" Then
    '        rptoption = 5
    '        'lblinfo1.Text = "Database: Ten; User Name: CBS"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "Report" Then
    '        rptoption = 6
    '        'lblinfo1.Text = "Database: Ten; User Name: CBS"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "KGB Business Progress Report" Then
    '        rptoption = 7
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    '        lblinfo2.Text = "Rename the EMail file 40101_XX-XX-XXXX.email as 'email.txt' and place in c:/du folder"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "KGB Day Book" Then
    '        rptoption = 8
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "Business Review" Then
    '        rptoption = 9
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "KGB First - Outstanding" Then
    '        Button3.Enabled = True
    '        rptoption = 10
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "KGB First - Disbursement" Then
    '        Button3.Enabled = True
    '        rptoption = 11
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "KGB First - NPA" Then
    '        Button3.Enabled = True
    '        rptoption = 12
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "MISDO Upload" Then
    '        rptoption = 13
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "ATM Data Mismatch between Finacle & Switch reports" Then
    '        rptoption = 14
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "CIBIL Upload File Creation" Then
    '        rptoption = 15
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "EMail Daily Reports" Then
    '        rptoption = 16
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "NPCI Linked Aadhaar - Upload file creation" Then
    '        rptoption = 17
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "Day end EMails" Then
    '        rptoption = 18
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "Business Review - Files to RO" Then
    '        rptoption = 19
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "KGB Aadhar Enrolled Status" Then
    '        rptoption = 20
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    '        lblinfo2.Text = "Rename the EMail file 40101_XX-XX-XXXX.email as email.txt and place in c:/du folder"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "KGB Daily Reports" Then
    '        rptoption = 21
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    '        lblinfo2.Text = "Rename the EMail file 40101_XX-XX-XXXX.email as 'email.txt' and place in c:/du folder"
    '        lblinfo3.Text = "Rename the NMGB Trial Balance(TB_XXXXXXXX.xls) as 'nmgb.txt' (Replace tab with |) and place in C:/DU folder"
    ...
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "9072 Insert" Then
    '        rptoption = 22
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "9074 Insert" Then
    '        rptoption = 23
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "9071 Insert" Then
    '        rptoption = 24
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "Create RO and Branch Folders and convert CIB Files" Then
    '        rptoption = 25
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "Create Bank as a whole/All RO's/All Branches report in a single file" Then
    '        rptoption = 26
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "Get File Names" Then
    '        rptoption = 27
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    '        lblinfo9.Text = ""
    '        lblinfo10.Text = ""
    '    ElseIf cmbOption.Text = "Word Document Generation" Then
    '        rptoption = 28
    '        'lblinfo1.Text = "Database: Ten; User Name: EMail"
    ...
    Sub option2()       'Daily EMails
        ...
        'file2 = "c:\du\email_2.txt"

        checkfile(file1, "Rename the EMail file 40101_XX-XX-XXXX.email as email.txt and place in c:/du folder")
        'checkfile(file2, "Rename the Second EMail file as email_2.txt and place in c:/du folder")
        ...
        '    tempdate2 = CDate(tempvar2)

        'Catch ex As Exception

        '    MsgBox("Invalid date in first line of email_1.txt file", MsgBoxStyle.Critical, "Invalid date")
        '    Exit Sub
        ...
        'If RptDate <> tempdate2 Then

        '    MsgBox("Report date and date in email_2.txt do not match", MsgBoxStyle.Critical, "Mismatch in date")
        '    Exit Sub
        ...
        'processmessage("Package - Data ID - 1011")

        'sql = "PKGEMAIL101.DATAID_1011"
        ...
        'processmessage("Package - Data ID - 1023")
    ...
    Sub uploadfiledata(ByVal filename As String, ByVal username As String, ByVal du_clear_flag As String)
        ...
        oracle_execute_non_query("ten", username, username, "truncate table z_email")
        'sql = "delete from c_du_bulk"
        'Dim cmd151 As New OracleCommand(sql, conn)
    ...
    Sub option36()          'ATM Transaction Status 
        ...
        Else
            ...
            'Dim cmd2 As New OracleCommand(sql, conn)
            'cmd2.CommandType = CommandType.StoredProcedure
            'cmd2.Parameters.Add("PROCESSFLAG", OracleDbType.Varchar2, 10, Nothing, ParameterDirection.Input).Value = "ALL"
            'cmd2.ExecuteNonQuery()
    ...
    Sub optionDynamic()  '
        ...
        While dr.Read()
            ...
            'SELECT  SUBSTR(LOC_BRANCH_CODE,2,4) SOLID ,LOC_BRANCH_CODE,LOC_LOCATION_CODE,PICK_DESCRIPTION FROM MIG_LOCATION, MIG_BRM007 WHERE LOC_BRANCH_CODE = PICK_BRANCH_CD AND PICK_KEY_TYPE = 701 AND PICK_CODE_NUM =  LOC_LOCATION_CODE ORDER BY 1, 2,3
            '4
            '2
            If match > 1 Then
    ...
    Private Sub option802()   'Inserting data to CIDMASTER from CEDGE_EXTRACT_CUSTOMERID table
        ...
        For Each dir1 In Directory.GetDirectories(access_db_path)
            ...
            If File.Exists(dir1.ToString() & "\server\" & acess_db) Then
                ...
                Dim sql As String
                'sql = "SELECT DISTINCT (CID),SOLID,CNAME,FATHER,RELATION,ADDRESS1,ADDRESS2,ADDRESS3,ADDRESS4,PINCODE,DOBSTRING FROM CEDGE_EXTRACT_CID WHERE SOLID = TO_CHAR(TO_NUMBER('" & solid.Trim() & "'))"
    ...
    Private Sub option811()   'Inserting data for Customer category
        ...
        For Each dir1 In Directory.GetDirectories(access_db_path)
            ...
            If File.Exists(dir1.ToString() & "\server\" & acess_db) Then
                ...
                ''Handling SOLID mismatch issue
                'If solid = "00701" Then
                '    sql = " SELECT  CBS_ID,CUST_FIRST_NAME,DECODE (CUST_TYPE, '2','BP','4','HP'), DECODE (CUST_SPEC_ATTR_CODE, '9' ,'GLD','8','JA','10','EX','7','SW')  FROM MIG_BRM001  WHERE CUST_BRANCH_CD = TO_NUMBER ( '3703' ) and (CUST_TYPE = '2' OR CUST_TYPE = '4' OR CUST_SPEC_ATTR_CODE BETWEEN 7 AND 10) AND CBS_ID IS NOT NULL "
                'ElseIf solid = "00704" Then
                '    sql = " SELECT  CBS_ID,CUST_FIRST_NAME,DECODE (CUST_TYPE, '2','BP','4','HP'), DECODE (CUST_SPEC_ATTR_CODE, '9' ,'GLD','8','JA','10','EX','7','SW')  FROM MIG_BRM001  WHERE CUST_BRANCH_CD = TO_NUMBER ( '1704' ) and (CUST_TYPE = '2' OR CUST_TYPE = '4' OR CUST_SPEC_ATTR_CODE BETWEEN 7 AND 10) AND CBS_ID IS NOT NULL "
                'ElseIf solid = "00176" Then
                '    sql = " SELECT  CBS_ID,CUST_FIRST_NAME,DECODE (CUST_TYPE, '2','BP','4','HP'), DECODE (CUST_SPEC_ATTR_CODE, '9' ,'GLD','8','JA','10','EX','7','SW')  FROM MIG_BRM001  WHERE CUST_BRANCH_CD = TO_NUMBER ( '1703' ) and (CUST_TYPE = '2' OR CUST_TYPE = '4' OR CUST_SPEC_ATTR_CODE BETWEEN 7 AND 10) AND CBS_ID IS NOT NULL "
                'Else
                '    sql = " SELECT  CBS_ID,CUST_FIRST_NAME,DECODE (CUST_TYPE, '2','BP','4','HP'), DECODE (CUST_SPEC_ATTR_CODE, '9' ,'GLD','8','JA','10','EX','7','SW')  FROM MIG_BRM001  WHERE TO_NUMBER(SUBSTR(CUST_BRANCH_CD,2,4)) = TO_NUMBER ( '" & solid & "' ) and (CUST_TYPE = '2' OR CUST_TYPE = '4' OR CUST_SPEC_ATTR_CODE BETWEEN 7 AND 10) AND CBS_ID IS NOT NULL "
            ...
            If File.Exists(dir1.ToString() & "\server\" & acess_db) Then
                ...
                While dr.Read()
                    ...
                    If opendatestring = "" Then
                        opendate = dob
                    End If
                    '// Logic to correct date .... While storing data baste this logic not working properly
                    'If Len(dobstring) = 8 Then
                    '    Dim temp() As String
                    '    If dobstring.Contains("-") Then
                    '        temp = dobstring.Split("-")
                    '        If Len(temp(0) = 1) Then
                    '            dobstring = String.Concat("0", dobstring)
                    '        Else
                    '            If Len(temp(2)) = 1 Then
                    '                temp(2) = String.Concat("0", temp(2))
                    '                dobstring = String.Concat(temp(0), "-", temp(1), "-", temp(2))
                    '            End If
                    ...
                    'If Len(dobstring) = 9 Then

                    '    Dim year As String
                    '    year = dobstring.Substring(7, 2)

                    '    If Val(year) > 14 Then
                    '        year = String.Concat("19", year)
                    '    Else
                    '        year = String.Concat("20", year)
                    '    End If
                    '    dobstring = String.Concat(dobstring.Substring(0, 7), year)
                    'Else
                    '    dobstring = "01-JAN-1900"
                    'End If
    ...
    Private Sub populate_dgv(ByVal code)
        ...
        db_open()
        If code = "0" Then
            sql = "SELECT CODE,DESCRIPTION FROM MENU"
        ElseIf code = "1" Then
            sql = "SELECT CODE,DESCRIPTION FROM MENU WHERE CODE LIKE'%" & txtcode.Text & "%' OR DESCRIPTION LIKE '%" & txtcode.Text & "%'"
        Else
            sql = "SELECT CODE,DESCRIPTION FROM MENU WHERE DESCRIPTION LIKE '%" & txtcode.Text & "%'"
        End If
    ...
    Private Sub populate_label()
        ...
        ElseIf txtmenu.Text = "ATM Transaction Status" Then
            ...
            lblinfo9.Text = ""
            lblinfo10.Text = ""
        ElseIf txtmenu.Text = "Upload data to tables - All Columns" Then
            rptoption = 37
            lblinfo2.Text = "Place the files having data in C:/DU"
            lblinfo3.Text = "Run the programme"
            lblinfo4.Text = "Data will be uploaded to the selected table"
            lblinfo5.Text = ""
            lblinfo6.Text = ""
            lblinfo7.Text = ""
            lblinfo8.Text = ""
            lblinfo9.Text = ""
            lblinfo10.Text = ""
        ElseIf txtmenu.Text = "Upload data to tables - Partial Columns" Then
            rptoption = 38
            'lblinfo1.Text = "Database: Ten; User Name: EMail"
            lblinfo2.Text = "Place the files having data in C:/DU"
            lblinfo3.Text = "Run the programme"
