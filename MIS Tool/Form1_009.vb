...
Public Class Form1
    ...
    Private Sub option601()   'eNMGB Migration - Create Branch Data
        ...
        If Not Directory.Exists("D:\DUMP\BR_" & solid) Then
            MsgBox("D:\DUMP\BR_" & solid & " folderpath not found. Create the folder, place dump and try again")
            Exit Sub
        End If

        If Not File.Exists("D:\DUMP\BR_" & solid & "\B" & solid & ".dmp") Then
            MsgBox("D:\DUMP\BR_" & solid & "\B" & solid & ".dmp file not found. Place dump and try again")
            Exit Sub
        End If

        If Not File.Exists("D:\DUMP\BR_" & solid & "\T" & solid & ".dmp") Then
            MsgBox("D:\DUMP\BR_" & solid & "\T" & solid & ".dmp file not found. Place dump and try again")
            Exit Sub
        End If

        '' drop and create user

        Dim sw0 As StreamWriter = New StreamWriter("d:\dump\script\create_user.bat")
        sw0.WriteLine("@echo off")
        sw0.WriteLine("sqlplus /nolog @d:\dump\script\create_user.sql")
        sw0.Close()

        Dim sw As StreamWriter = New StreamWriter("d:\dump\script\create_user.sql")
        ...
        Process.Start("d:\dump\script\create_user.bat")
        ...
        Dim sw1 As StreamWriter = New StreamWriter("d:\dump\script\import_user_br.bat")
        sw1.WriteLine("@echo off")
        sw1.WriteLine("imp " & import_user & "/" & import_user & "@ten file=D:\DUMP\BR_" & solid & "\B" & solid & ".dmp  full=yes")
        sw1.Close()
        Process.Start("d:\dump\script\import_user_br.bat")
        ...
        Dim sw2 As StreamWriter = New StreamWriter("d:\dump\script\rename_table.sql")
        sw2.WriteLine("rename mig_tran to mig_tran1;")
        sw2.WriteLine("rename mig_tran_narration to mig_tran_narration1;")
        sw2.Close()

        Dim sw3 As StreamWriter = New StreamWriter("d:\dump\script\rename_table.bat")
        sw3.WriteLine("@echo off")
        sw3.WriteLine("sqlplus " & import_user & "/" & import_user & "@ten @D:\dump\script\rename_table.sql /nolog ")
        sw3.Close()

        Process.Start("d:\dump\script\rename_table.bat")
        ...
        Dim sw4 As StreamWriter = New StreamWriter("d:\dump\script\import_user_tr.bat")
        sw4.WriteLine("@echo off")
        sw4.WriteLine("imp " & import_user & "/" & import_user & "@ten file=D:\DUMP\BR_" & solid & "\T" & solid & ".dmp  full=yes")
        sw4.Close()
        Process.Start("d:\dump\script\import_user_tr.bat")
        ...
        Dim sw5 As StreamWriter = New StreamWriter("d:\dump\script\move_data.sql")
        ...
        Dim sw6 As StreamWriter = New StreamWriter("d:\dump\script\move_data.bat")
        sw6.WriteLine("@echo off")
        sw6.WriteLine("sqlplus " & import_user & "/" & import_user & "@ten @D:\dump\script\move_data.sql /nolog ")
        sw6.Close()

        Process.Start("d:\dump\script\move_data.bat")
        ...
        Dim sw7 As StreamWriter = New StreamWriter("d:\dump\script\create_table.bat")
        sw7.WriteLine("@echo off")
        sw7.WriteLine("sqlplus " & import_user & "/" & import_user & "@ten @D:\dump\static\Table1.sql /nolog ")
        sw7.WriteLine("sqlplus " & import_user & "/" & import_user & "@ten @D:\dump\static\Table2.sql /nolog ")
        sw7.Close()

        Process.Start("d:\dump\script\create_table.bat")
        ...
        Dim sw8 As StreamWriter = New StreamWriter("d:\dump\script\mig_grant.sql")
        ...
        Dim sw9 As StreamWriter = New StreamWriter("d:\dump\script\cbs_grant.sql")
        ...
        Dim sw110 As StreamWriter = New StreamWriter("d:\dump\script\grant.bat")
        sw110.WriteLine("@echo off")
        sw110.WriteLine("sqlplus mig/mig@ten @d:\dump\script\mig_grant.sql /nolog")
        sw110.WriteLine("sqlplus cbs/cbs@ten @d:\dump\script\cbs_grant.sql /nolog")
        sw110.Close()

        Process.Start("d:\dump\script\grant.bat")
        ...
        Dim sw11 As StreamWriter = New StreamWriter("d:\dump\script\create_package.bat")
        sw11.WriteLine("@echo off")
        sw11.WriteLine("sqlplus " & import_user & "/" & import_user & "@ten @D:\dump\static\Package.sql /nolog ")
        sw11.Close()

        Process.Start("d:\dump\script\create_package.bat")
        ...
        Dim sw12 As StreamWriter = New StreamWriter("d:\dump\script\run_scripts.bat")
        sw12.WriteLine("@echo off")
        sw12.WriteLine("sqlplus " & import_user & "/" & import_user & "@ten @D:\dump\static\Update.sql /nolog ")
        sw12.Close()

        Process.Start("d:\dump\script\run_scripts.bat")
    ...
    Private Sub option609()   'eNMGB Migration - Split CEDGE Dump
        ...
        Dim sw0 As StreamWriter = New StreamWriter("d:\dump\script\split_dump_create_user.bat")
        sw0.WriteLine("@echo off")
        sw0.WriteLine("sqlplus /nolog @d:\dump\static\split_dump_create_user.sql")
        sw0.Close()
        Process.Start("d:\dump\script\split_dump_create_user.bat")
        ...
        Dim sw6 As StreamWriter = New StreamWriter("d:\dump\script\create_tables.bat")
        sw6.WriteLine("@echo off")
        sw6.WriteLine("sqlplus " & import_user & "/" & import_user & "@ten @D:\dump\static\split_dump_create_tables.sql /nolog ")
        sw6.Close()

        Process.Start("d:\dump\script\create_tables.bat")
        ...
        Dim sw4 As StreamWriter = New StreamWriter("d:\dump\script\import_cedge_dump.bat")
        sw4.WriteLine("@echo off")
        sw4.WriteLine("imp " & import_user & "/" & import_user & "@ten file=" & dumpname & "  full=yes")
        sw4.Close()
        Process.Start("d:\dump\script\import_cedge_dump.bat")
        ...
        Dim sw16 As StreamWriter = New StreamWriter("d:\dump\script\update_package.bat")
        sw16.WriteLine("@echo off")
        sw16.WriteLine("sqlplus " & import_user & "/" & import_user & "@ten @D:\dump\static\split_dump_move_data.sql /nolog ")
        sw16.Close()

        Process.Start("d:\dump\script\update_package.bat")
        ...
        While dr5.Read
            ...
            Dim sw17 As StreamWriter = New StreamWriter("d:\dump\script\export_user_" & uname & ".bat")
            sw17.WriteLine("@echo off")
            sw17.WriteLine("exp " & uname & "/" & uname & "@TEN file=D:\" & bcode & ".dmp log=D:\" & bcode & ".log")
            sw17.Close()

            Process.Start("d:\dump\script\export_user_" & uname & ".bat")
    ...
    Private Sub option602() 'eNMGB Migration - Upload Migration Tool Files
        ...
        For i = 101 To 115
            ...
            checkfilename = "d:\dump\BR_" & solid & "\MTR_" & solid.Substring(2, 3) & "\" & solid.Substring(2, 3) & "_816_" & i.ToString() & ".txt"
    ...
    Private Sub option603() 'eNMGB Migration - Upload CGL File
        ...
        If File.Exists("d:\dump\BR_" & solid & "\CGL.txt") Then
            uploadfiledata_without_trim_MigrationTool("d:\dump\BR_" & solid & "\CGL.txt", username, "Y")
        Else
            MsgBox("File Named d:\dump\BR_" & solid & "\CGL.txt not found in d:\dump folder", MsgBoxStyle.Information)
            Exit Sub
        End If
    ...
    Private Sub option605()   'eNMGB Migration - FUF Generation
        ...
        Dim migdate As Date = InputBox("Enter Date of Migration (DD/MM/YYYY)", "Enter Value", "30-06-2014")
        ...
        If IsNumeric(reportid.Substring(0, 1)) = True Then
            ...
            While dr2.Read
                ...
                If reportid1 = "EMI" Then
                    ...
                    Dim sw7 As StreamWriter = New StreamWriter("d:\dump\script\create_table4.bat")
                    sw7.WriteLine("@echo off")
                    sw7.WriteLine("sqlplus " & username & "/" & username & "@ten @D:\dump\static\Table4.sql /nolog ")
                    sw7.Close()
                    Process.Start("d:\dump\script\create_table4.bat")
                    uconfirm = InputBox("Enter Y and press OK once the process is over", "Confirm", "Y")
                    If uconfirm <> "Y" Then
                        MsgBox("Exiting application")
                        Exit Sub
                    ...
                    Dim sw17 As StreamWriter = New StreamWriter("d:\dump\script\create_table3.bat")
                    sw17.WriteLine("@echo off")
                    sw17.WriteLine("sqlplus " & username & "/" & username & "@ten @D:\dump\static\Table3.sql /nolog ")
                    sw17.Close()
                    Process.Start("d:\dump\script\create_table3.bat")
                    uconfirm = InputBox("Enter Y and press OK once the process is over", "Confirm", "Y")
                    If uconfirm <> "Y" Then
                        MsgBox("Exiting application")
                        Exit Sub
    ...
    Private Sub option606()   'eNMGB Migration - Data Check Reports
        Dim mdate As String = InputBox("Enter migration date", "", "30-06-2014")
    ...
    Private Sub populate_dgv(ByVal code)
        ...
        'If code = "0" Then
        '    sql = "SELECT CODE,DESCRIPTION FROM Z_MT_MENU WHERE STATUS IS NULL"
        'ElseIf code = "1" Then
        '    sql = "SELECT CODE,DESCRIPTION FROM Z_MT_MENU WHERE CODE LIKE'%" & txtcode.Text & "%' OR DESCRIPTION LIKE '%" & txtcode.Text & "%' AND STATUS IS NULL"
        'Else
        '    sql = "SELECT CODE,DESCRIPTION FROM Z_MT_MENU WHERE DESCRIPTION LIKE '%" & txtcode.Text & "%' AND STATUS IS NULL "
        'End If
        'Dim cmd As New OracleCommand(sql, oracle_conn)
        'Dim dr As OracleDataReader = cmd.ExecuteReader()
        'While dr.Read
        ...
        '    dgv1.Rows.Item(n).Cells(0).Value = dr.Item("CODE").ToString.Trim
        '    dgv1.Rows.Item(n).Cells(1).Value = dr.Item("DESCRIPTION").ToString.Trim
