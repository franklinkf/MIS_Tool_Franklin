...
Public Class Form1
    ...
    End Sub
    Private Sub option832()   'Generating Report File From dump
        ...
        If branchcode = "ALL" Then
            ...
            While dr1.Read
                ...
                If reportid = "ALL" Then
                    ...
                    Dim sql3 As String
                    sql3 = "SELECT REPORT_ID,REPORT_FILE_NAME FROM REPORT_INDEX WHERE REPORT_TYPE = 'DC' ORDER BY REPORT_TYPE"
                ...
                Else
                    ...
                    Dim sql4 As String
                    sql4 = "SELECT REPORT_ID,REPORT_FILE_NAME FROM REPORT_INDEX WHERE REPORT_TYPE = 'DC' AND REPORT_ID =  '" & reportid & "' ORDER BY REPORT_TYPE"
    ...
    Private Sub populate_label()
        ...
        ElseIf txtmenu.Text = "Generating Report File From dump" Then
            rptoption = 832
            'lblinfo1.Text = "Database: Ten; User Name: EMail"
