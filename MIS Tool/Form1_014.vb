...
Public Class Form1
    ...
    Private Sub populate_label()
        ...
        ElseIf txtmenu.Text = "Bulk SMS File Creation" Then
            rptoption = 46
            'lblinfo1.Text = "Database: Ten; User Name: EMail"
            lblinfo2.Text = "Enter the message in the Iputbox"
            lblinfo3.Text = "SMSUPLOADFILE.txt Generated in C:\temp folder"
            lblinfo4.Text = "Log in Production Server (MAKER USER)"
            lblinfo5.Text = "Menu batchupd  Mode : U, Upload name: SMSBATCH, Filename:SMSUPLOADFILE.txt"
            lblinfo6.Text = "Take Menu PR and find out the uplaodID "
            lblinfo7.Text = "Log in Production Server (CHECKER USER)"
            lblinfo8.Text = "Menu batchupd  Mode : V, Upload name: SMSBATCH, Enter uploadID"
            lblinfo9.Text = "After Verification SMS send to all mobile numbers in the file"
            lblinfo10.Text = ""
    ...
    Sub option46()      'SMS File Creation
        ...
        Dim msg As String
        Dim Filename As String = "C:\temp\SMSUPLAODFILE.txt"
        ...
        sql = "SELECT MOBILE_NUM FROM Z_CUG"
        Dim cmd1 As New OracleCommand(sql, conn)
        Dim dr As OracleDataReader = cmd1.ExecuteReader()
        Dim linedata As String
        Dim sw As StreamWriter = New StreamWriter(filename.ToString())
