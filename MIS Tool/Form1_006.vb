    ...
    Private Sub option605()   'eNMGB Migration - FUF Generation
        ...
        If username.Length > 4 Then
            ...
            If username.Substring(0, 4).ToUpper = "MIG0" Then
                ...
                Dim lineno As String = InputBox("Enter No of lines per file", "Enter Value", "Custom")
                ...
                If Directory.Exists(folderpath) Then
                    For Each file1 As String In Directory.GetFiles(folderpath)
                        Dim filepath() As String = file1.Split("\")
                        Dim filename As String = filepath(filepath.Length - 1)
                        If reportid = "ALL" Or IsNumeric(reportid.Substring(0, 1)) = True Then
                            If File.Exists(folderpath & "\" & filename) Then
                                File.Delete(folderpath & "\" & filename)
                            End If
                        Else
                            If filename.Trim.Substring(5, 3) = reportid.Trim.Substring(0, 3) Then
                                File.Delete(folderpath & "\" & filename)
                            End If
                        End If
                ...
                If IsNumeric(reportid.Substring(0, 1)) = True Then
                    ...
                    sql2 = "SELECT SLNO,REPORT_ID,REPORT_DESC,REPORT_FILE_NAME FROM RI WHERE REPORT_TYPE = 'FUF' AND SLNO BETWEEN " & startid & " AND " & endid & " ORDER BY SLNO"
                ...
                Else
                    ...
                    Else
                        ...
                        sql2 = "SELECT SLNO,REPORT_ID,REPORT_DESC,REPORT_FILE_NAME FROM RI WHERE REPORT_TYPE = 'FUF' AND REPORT_ID =  '" & reportid & "'"
                ...
                Else
                    ...
                    Dim cmd4 As New OracleCommand(sql2, oracle_conn)
                    ...
                    While dr4.Read()
                        ...
                        reportdesc = dr4.Item("REPORT_DESC").ToString.Trim
                        fileno = dr4.Item("SLNO").ToString.Trim
